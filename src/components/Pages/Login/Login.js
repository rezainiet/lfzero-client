...
const Login = () => {
  ...
  const forgotFn = async () => {
    if (!email) {
      return alert("Please, write your email id.");
    }
      ...
      <div className="max-w-7xl mx-auto flex justify-between py-12 px-1 lg:px-2 xl:px-0">
        <div className="flex-1">
          ...
          >
            ...
            <a
              onClick={forgotFn}
              className="font-semibold text-[#643CF4] my-2"
              href="#"
              alt=""
            >
              Forgot Password
            ...
            <input
              className="text-md my-2 px-5 py-3 rounded-full outline-[#F53289] bg-gradient-to-r from-[#f7d7e5] to-[#F53289] hover:from-[#F53289] hover:to-[#f7d7e5] text-white cursor-pointer"
