                ...
                <div class="container px-5 py-8 mx-auto blog-post" >
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0" >
                            <h2 class="text-sm title-font text-gray-500 tracking-widest" >Author: <span>{author}</span></h2>
                            ...
                            <div class="flex">
                                ...
                                <button class="flex ml-auto text-white bg-indigo-500 border-0 mt-3 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Read More</button>
                                <button class="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 mt-3 inline-flex items-center justify-center text-gray-500 ml-4">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
