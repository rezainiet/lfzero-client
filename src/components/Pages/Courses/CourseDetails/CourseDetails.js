    ...
    return (
        <div>
            <div className='mx-5 my-20 flex'>
                <div>
                    <div className='inline-block w-5/6 items-center'>
                        ...
                        <div className='bg-gray-500 bg-opacity-20 rounded-2xl py-3 px-3 flex items-center'>
                            <img src="https://img.icons8.com/fluency/48/000000/teacher.png" alt='tutor icon' />
                            <div className='ml-2'>
                                <p className='text-gray-800 text-lg font-bold'>{course?.instructor}</p>
                                <p className='text-sm text-gray-500 font-semibold -mt-2'>Course Tutor</p>
                            </div>
                            <div className='flex justify-end'>
                                <img src="https://img.icons8.com/fluency/48/000000/plus-2-math.png" alt='plus' className='ml-20' />
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                            <p className='my-5 text-xl'><span className='font-semibold'>Course</span> Details</p>
                                ...
                                <div className='flex items-center gap-3'>
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <p className='-mt-1 text-sm text-gray-500'>500 hours + Length</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className='flex items-center gap-3'>
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <p className='-mt-1 text-sm text-gray-500'>120+ Quizzes</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className='flex items-center gap-3'>
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <p className='-mt-1 text-sm text-gray-500'>12 Assignment</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className=''>
                    {/* Course image here */}
                    <img src='https://cdn.dribbble.com/users/4678459/screenshots/15331994/media/23c45a26f0cadd83d316bb8333db8d9a.png' width={500} alt="" />

                    <button className='bg-[#F53289] text-white px-7 py-2 rounded-full mt-5' onClick={() => handleSubmitOrder(course.price)}>Enroll Now!</button>
                </div>
            </div>
        </div>
    );
