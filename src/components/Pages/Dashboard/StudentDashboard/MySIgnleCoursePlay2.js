        ...
        <div className='max-w-7xl mx-auto '>
            <div className='md:grid gap-5 grid-cols-10 pb-2 mx-2'>
                <div className='col-start-1 lg:col-start-1 col-end-7 lg:col-end-8'>
                    ...
                    <iframe className='w-full' ref={videoRef} height="515" src="https://www.youtube.com/embed/rrj9yiHrKc4?autoply=0&controls=1&modestbranding=0&disablekb=1&rel=0" rel="0" title="Test Title" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
