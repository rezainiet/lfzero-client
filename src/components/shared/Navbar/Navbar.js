  ...
  return (
    <div className="bg-[#5D10E3] sm:px-20">
      <div className="flex justify-between items-center p-6 px-6 lg:px-0 container mx-auto ">
        {/* Logo */}
        <div className="flex justify-between w-full xl:w-[150px]">
          <div
        ...
        {/* Menu navbar */}
        <div className={`${check ? "top-[80px]" : "top-[-280px]"} flex-1 flex absolute lg:static z-50 lg:z-0 bg-gradient-to-b from-[#5119CD] to-blue-600 lg:bg-gradient-to-b lg:from-[#5d10e3] lg:to-[#5d10e3] w-full left-0 lg:justify-between lg:items-center flex-col lg:flex-row justify-center items-center text-center duration-700`}>
          <div
            className="">
            <div
              className="text-white lg:bg-transparent flex flex-col lg:items-center lg:flex-row lg:px-6 space-y-2 pt-3 lg:pt-0 lg:space-y-0 lg:space-x-3">
              <a href="#">Category</a>
          ...
          <div
            className="">
            <div
              className="lg:bg-transparent py-2 lg:py-10 lg:py-0 flex flex-col lg:items-center lg:flex-row px-6 space-y-2 
          ...
          <div
            className="">
            <div
              className="lg:bg-transparent pt-2 pb-5 lg:py-10 lg:py-0 flex flex-col lg:items-center lg:flex-row px-6 space-y-4 
                    lg:space-y-0 lg:space-x-3">
              {/* login */}
              {user ? (
                <>
            ...
            <div className="dropdown dropdown-end">
              <label tabIndex={0} className="btn ml-2 border-none p-0">
                <img
                  ...
                  className='w-[44px] lg:min-w-[40px] lg:w-[200px] xl:w-[40px] rounded'
                  alt=""
                ></img>
              </label>
              <ul
